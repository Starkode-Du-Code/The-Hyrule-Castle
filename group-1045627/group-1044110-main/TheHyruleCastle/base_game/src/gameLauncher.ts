...
export class GameLauncher {
    ...
    private dataDir: string = process.env.DATA_DIR || '/app/data';
    
    // Utilisation de chemins absolus pour accéder aux fichiers JSON
    private movesJson: any = JSON.parse(readFileSync(path.join(this.dataDir, 'moves.json'), 'utf-8'));
    private enemieJson: any = JSON.parse(readFileSync(path.join(this.dataDir, 'enemies.json'), 'utf-8'));
    private playerJson: any = JSON.parse(readFileSync(path.join(this.dataDir, 'players.json'), 'utf-8'));
    private bossJson: any = JSON.parse(readFileSync(path.join(this.dataDir, 'bosses.json'), 'utf-8'));
