...
export class GameLauncher {
    ...
    private movesJson: any = JSON.parse(fs.readFileSync(`${this.dataDir}/moves.json`, 'utf-8'));
    private enemieJson: any = JSON.parse(fs.readFileSync(`${this.dataDir}/enemies.json`, 'utf-8'));
    private playerJson: any = JSON.parse(fs.readFileSync(`${this.dataDir}/players.json`, 'utf-8'));
    private bossJson: any = JSON.parse(fs.readFileSync(`${this.dataDir}/bosses.json`, 'utf-8'));
    private classJson: any = JSON.parse(fs.readFileSync(`${this.dataDir}/class.json`, 'utf-8'));
    private lootJson: any = JSON.parse(fs.readFileSync(`${this.dataDir}/loot.json`, 'utf-8'));
